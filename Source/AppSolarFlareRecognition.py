...
print ".|>>>> "+str(len(lst_patterns))
file_01 = open("plot_class_A.txt","w")
str_line = str(lst_patterns[0].contrast/max_contrast)
str_line = str_line +"\t"+str(lst_patterns[0].correlation/max_correlation)
str_line = str_line +"\t"+str(lst_patterns[0].energy/max_energy)
str_line = str_line +"\t"+str(lst_patterns[0].entropy/min_entropy)
str_line = str_line +"\t"+str(lst_patterns[0].homogeneity/max_homogeneity)+"\n"
file_01.write(str_line)
file_01.close()

file_01 = open("plot_class_B.txt","w")
str_line = str(lst_patterns[1].contrast/max_contrast)
str_line = str_line +"\t"+str(lst_patterns[1].correlation/max_correlation)
str_line = str_line +"\t"+str(lst_patterns[1].energy/max_energy)
str_line = str_line +"\t"+str(lst_patterns[1].entropy/min_entropy)
str_line = str_line +"\t"+str(lst_patterns[1].homogeneity/max_homogeneity)+"\n"
file_01.write(str_line)
file_01.close()

file_01 = open("plot_class_C.txt","w")
str_line = str(lst_patterns[3].contrast/max_contrast)
str_line = str_line +"\t"+str(lst_patterns[3].correlation/max_correlation)
str_line = str_line +"\t"+str(lst_patterns[3].energy/max_energy)
str_line = str_line +"\t"+str(lst_patterns[3].entropy/min_entropy)
str_line = str_line +"\t"+str(lst_patterns[3].homogeneity/max_homogeneity)+"\n"
file_01.write(str_line)
file_01.close()

file_01 = open("plot_class_D.txt","w")
str_line = str(lst_patterns[4].contrast/max_contrast)
str_line = str_line +"\t"+str(lst_patterns[4].correlation/max_correlation)
str_line = str_line +"\t"+str(lst_patterns[4].energy/max_energy)
str_line = str_line +"\t"+str(lst_patterns[4].entropy/min_entropy)
str_line = str_line +"\t"+str(lst_patterns[4].homogeneity/max_homogeneity)+"\n"
file_01.write(str_line)
file_01.close()

file_01 = open("plot_class_E.txt","w")
str_line = str(lst_patterns[5].contrast/max_contrast)
str_line = str_line +"\t"+str(lst_patterns[5].correlation/max_correlation)
str_line = str_line +"\t"+str(lst_patterns[5].energy/max_energy)
str_line = str_line +"\t"+str(lst_patterns[5].entropy/min_entropy)
str_line = str_line +"\t"+str(lst_patterns[5].homogeneity/max_homogeneity)+"\n"
file_01.write(str_line)
file_01.close()

file_01 = open("plot_class_F.txt","w")
str_line = str(lst_patterns[6].contrast/max_contrast)
str_line = str_line +"\t"+str(lst_patterns[6].correlation/max_correlation)
str_line = str_line +"\t"+str(lst_patterns[6].energy/max_energy)
str_line = str_line +"\t"+str(lst_patterns[6].entropy/min_entropy)
str_line = str_line +"\t"+str(lst_patterns[6].homogeneity/max_homogeneity)+"\n"
file_01.write(str_line)
file_01.close()
...
file_name = file_name + ".txt"
file_out = open(db_images.str_report_path+file_name,"w")
file_A  = open("plot_win_A.txt","w'")
file_B  = open("plot_win_B.txt","w'")
file_C  = open("plot_win_C.txt","w'")
file_D  = open("plot_win_D.txt","w'")
file_E  = open("plot_win_E.txt","w'")
file_F  = open("plot_win_F.txt","w'")
...
for solar_disk in lst_solar_disk:
    for window in solar_disk.lst_windows:
        ...
        for pattern in lst_patterns:
            ...
            if distance <= L2:
                print ".|... "+ str(pattern.class_name)
                #win_name = db_images.str_report_path+"True/"+solar_disk.pattern_name+"_win_"+str(window.nro_line)+"_"+str(window.nro_column)+\
                ...
                if count_count:
                    ...
                    count_count = False
                file_out.write(str_line)
                if pattern.class_name == 'A':
                    file_A.write(str_line2)
                if pattern.class_name == 'B' or pattern.class_name == 'C':
                    file_B.write(str_line2)
                if pattern.class_name == 'D':
                    file_C.write(str_line2)
                if pattern.class_name == 'E':
                    file_D.write(str_line2)
                if pattern.class_name == 'F':
                    file_E.write(str_line2)
                if pattern.class_name == 'G':
                    file_F.write(str_line2)
            else:
                #win_name = db_images.str_report_path+"False/"+solar_disk.pattern_name+"_win_"+str(window.nro_line)+"_"+str(window.nro_column)+\
                #       "_"+str(pattern.class_name)+"_("+str(distance)+").jpg"
                #image_tools.arr2img(window.arr_image).save(win_name)
